...
const Dashboard = () => {
    ...
    const dashboardCards = [
        { title: "Toal Bookings", value: dashboardData.totalBookings || "0", icon: ChartLineIcon },
        { title: "Toal Revenue", value: currency + dashboardData.totalRevenue || "0", icon: CircleDollarSignIcon },
